...
while(guestlist.length > 2) {
    ...
    console.log(`Sorry, ${removedGuest} I can't invite you to dinner because table will not be available`);
}

//making 2 guests know that they are still invited
console.log("Invitations to the last two guests");
guestlist.forEach(lasttwo => console.log(`Luckily, ${lasttwo} You are still invite for the dinner`));
